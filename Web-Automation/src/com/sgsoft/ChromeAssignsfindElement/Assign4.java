...
public class Assign4 {
	...
	static void modifyCustomer()
	{
		try
		{
			...
			Thread.sleep(2000);
			drive.findElement(By.xpath("//*[@id='taskListBlock']/div[2]/div[2]/div[1]/div[3]/div[2]/div/div[1]/textarea")).sendKeys("Community Means Strength");
			Thread.sleep(1000);
			drive.findElement(By.xpath("//*[@id='taskListBlock']/div[2]/div[1]/div[1]")).click();
			Thread.sleep(1000);
		}catch(Exception e)
		{
			e.printStackTrace();
