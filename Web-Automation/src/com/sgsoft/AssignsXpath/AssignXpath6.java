...
public class AssignXpath6 {
	...
	static void modifyProject()
	{
		try
		{
			...
			Thread.sleep(2000);
			ChDrive.findElement(By.xpath("//*[@*='Enter project description...']")).sendKeys("Very Confidential");
			Thread.sleep(1500);
			ChDrive.findElement(By.xpath("//div[@class='edit_project_sliding_panel sliding_panel']//div[@class='closeButton']")).click();
			Thread.sleep(2000);
		}catch(Exception e)
		{
			e.getMessage();
