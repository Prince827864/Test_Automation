package com.sgsoft.AssignsLogs;
...
public class LogAssign_2 {

	public static Logger log=Logger.getLogger("AssignsLogs, LogAssign_2");
	...
	static void createUser()
	{
		try
		{
			...
			driver.findElement(By.xpath("//input[@name='email']")).sendKeys("user1@gmail.com");
	...
	static void modifyUser()
	{
		try
		{
			log.info("The modifyUser() method has started");
			...
			log.info("The modifyUser() method has ended");
			log.info("------------------------------------------");
		}
		catch(Exception e)
		{
